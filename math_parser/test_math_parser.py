...
class TestMathPasrser(unittest.TestCase):
  def test_math_parser(self):
    ...
    # self.assertEqual(MathParser('4*8').calculate(), 32.0)
    ...
    # self.assertEqual(MathParser('4-1+13').calculate(), 16.0)
    # self.assertEqual(MathParser('-7/2-5*2+4').calculate(), -9.5)
    # self.assertEqual(MathParser('13-4*2+(4-9/3)-1').calculate(), 5.0)
    # self.assertEqual(MathParser('1+(44-28)/(2+7*(5-3).calculate())-2').calculate(), 0.0)
    # self.assertEqual(MathParser('36.01-4+(-4.0/2+1)*(1+7.455*(-1-3).calculate())-23').calculate(), 37.83)
